    ...
    (function (global, factory) {
      ...
      var diffMethodMap =
        ...
        babelHelpers.defineProperty(
          _diffMethodMap,
          AlgorithmTypes2.CIEDE2000,
          "ciede2000"
        ),
        babelHelpers.defineProperty(_diffMethodMap, AlgorithmTypes2.HSV, "hsv"),
        babelHelpers.defineProperty(_diffMethodMap, AlgorithmTypes2.RGB, "rgb"),
        _diffMethodMap);
      var kl = 1;
      var kc = 1;
      var kh = 1;
        ...
        babelHelpers.createClass(ColorDiff2, null, [
          ...
          },
          {
            ...
            value: function _ciede2000(l1, a1, b1, l2, a2, b2) {
              ...
              var h1p =
                b1 === 0 && a1p === 0 ? 0 : h1pd > 0 ? h1pd : h1pd + 360;
              var h2pd = degrees(atan2(b2, a2p));
              var h2p =
                b2 === 0 && a2p === 0 ? 0 : h2pd > 0 ? h2pd : h2pd + 360;
              var dlp = l2 - l1;
              var dcp = c2p - c1p;
              var dhp =
                2 *
      ...
      function equal(a, b) {
        ...
        return (
          ...
          (typeof b === "undefined" ? "undefined" : babelHelpers.typeof(b))
        );
      }
          ...
          },
          {
            ...
            value: function setAlgorithmType(algorithmType) {
              if (!AlgorithmTypes2.hasOwnProperty(algorithmType)) {
                ColorClassifier3.throwError(
                  algorithmType + " is an undefined algorithm type."
                );
              }
            ...
            value: function classify(value) {
              ...
              palette.forEach(function (paletteColor) {
                array.push({
                  ...
                  color:
                    format2 === "raw" ? paletteColor : paletteColor[format2],
                });
              });
          ...
          },
          {
            ...
            value: function classifyFromArray(colors) {
              ...
              array.forEach(function (obj) {
                ...
                var _results$filter2 = babelHelpers.slicedToArray(
                  _results$filter,
                  1
                );
...
var Debugout = (function () {
  function t(t2) {
    ...
    for (var i in o) o[i] !== void 0 && (this[i] = o[i]);
    if (this.useLocalStorage && window && window.localStorage) {
      ...
      if (r) {
        ...
        this.logMetadata("Last session end: " + r.lastLog),
          this.logMetadata(
            "Last " + this.formatSessionDuration(this.startTime, n)
          ),
          this.startLog();
      } else this.startLog();
  ...
  return (
    ...
    (t.prototype.log = function () {
      ...
      this.realTimeLoggingOn && console.log.apply(console, t2),
        this.recordLogs && this.recordLog.apply(this, t2);
    }),
    (t.prototype.info = function () {
      for (var t2 = [], e = 0; e < arguments.length; e++) t2[e] = arguments[e];
      this.realTimeLoggingOn && console.info.apply(console, t2),
        this.recordLogs &&
          ((this.output += "[INFO] "), this.recordLog.apply(this, t2));
    }),
    (t.prototype.warn = function () {
      for (var t2 = [], e = 0; e < arguments.length; e++) t2[e] = arguments[e];
      this.realTimeLoggingOn && console.warn.apply(console, t2),
        this.recordLogs &&
          ((this.output += "[WARN] "), this.recordLog.apply(this, t2));
    }),
    (t.prototype.error = function () {
      for (var t2 = [], e = 0; e < arguments.length; e++) t2[e] = arguments[e];
      this.realTimeLoggingOn && console.error.apply(console, t2),
        this.recordLogs &&
          ((this.output += "[ERROR] "), this.recordLog.apply(this, t2));
    }),
    (t.prototype.debug = function () {
      for (var t2 = [], e = 0; e < arguments.length; e++) t2[e] = arguments[e];
      this.realTimeLoggingOn && console.debug.apply(console, t2),
        this.recordLogs &&
          ((this.output += "[DEBUG] "), this.recordLog.apply(this, t2));
    }),
    (t.prototype.getLog = function () {
      var t2 = new Date();
      if (
        (this.recordLogs || this.info("Log recording is off"),
        this.useLocalStorage && window && window.localStorage)
      ) {
        var e = this.load();
        e && ((this.startTime = new Date(e.startTime)), (this.output = e.log));
      }
      return this.includeSessionMetadata
        ? this.output +
            "---- " +
            this.formatSessionDuration(this.startTime, t2) +
            " ----\n"
        : this.output;
    }),
    ...
    (t.prototype.downloadLog = function () {
      if (window) {
        var t2 = this.getLog(),
          e = new Blob([t2], { type: "data:text/plain;charset=utf-8" }),
          o = document.createElement("a");
        (o.href = window.URL.createObjectURL(e)),
          (o.target = "_blank"),
          (o.download = this.logFilename),
    ...
    (t.prototype.stringifyArray = function (t2, e) {
      ...
      if (t2.length > 0) {
        ...
        for (var n = 0; n < t2.length; n++) {
          var s = this.determineType(t2[n]),
            a = false;
          s === "Object" && this.objectSize(t2[n]) > 0 && (a = true),
            s === "Array" && t2[n].length > 0 && (a = true),
            !r && a && (o += "\n");
          var u = this.stringify(t2[n], i);
          u &&
            (a && (o += this.indentsForDepth(i)),
            (o += u),
            n < t2.length - 1 && (o += ", "),
            a && (o += "\n")),
            (r = a);
    ...
    (t.prototype.trimLog = function (t2) {
      ...
      return (
        e.pop(),
        e.length > t2 && (e = e.slice(e.length - t2)),
        e.join("\n") + "\n"
      );
    }),
    (t.prototype.formatSessionDuration = function (t2, e) {
      var o = e - t2,
        ...
        r = ("0" + i).slice(-2);
      o -= 1e3 * i * 60 * 60;
      var n = Math.floor(o / 1e3 / 60),
        s = ("0" + n).slice(-2);
      o -= 1e3 * n * 60;
      var a = Math.floor(o / 1e3);
      return (
        (o -= 1e3 * a),
        "Session duration: " + r + ":" + s + ":" + ("0" + a).slice(-2)
      );
    }),
...
var createAuthorKeyFullName = (creators) => {
  ...
  if (authorKey.length == 3) {
    authorKeyFixed =
      authorKey[0] + ", " + authorKeyReverse[1] + " and " + authorKeyReverse[2];
  }
  if (authorKey.length > 3) {
    authorKeyFixed = authorKey[0] + " et al.";
  }
  ...
  if (editorKey.length == 3) {
    editorKeyFixed =
      editorKey[0] + ", " + editorKeyReverse[1] + " and " + editorKeyReverse[2];
  }
  if (authorKey.length > 3) {
    editorKeyFixed = editorKey[0] + " et al.";
  }
  ...
  for (let creatorindex = 0; creatorindex < creators.length; creatorindex++) {
    ...
    if (creator.creatorType === "author") {
      if (creator.hasOwnProperty("name")) {
        ...
        authorKey.push(
          creator.lastName + ", " + creator.firstName.substring(0, 1) + "."
        );
      } else if (
        creator.hasOwnProperty("lastName") &&
        !creator.hasOwnProperty("firstName")
...
function createLocalFileLink(reference2) {
  ...
  for (
    ...
    attachmentindex < reference2.attachments.length;
    attachmentindex++
  ) {
    ...
    const selectedfile =
      "[" +
      reference2.attachments[attachmentindex].title +
      "](file:///" +
      encodeURI(
        reference2.attachments[attachmentindex].path.replaceAll(" ", " ")
      ) +
      ")";
...
function createLocalFilePathLink(reference2) {
  ...
  for (
    ...
    const selectedFilePath =
      ...
      reference2.attachments[attachmentindex].title +
      "](" +
      encodeURI(reference2.attachments[attachmentindex].select) +
      ")";
...
function createZoteroReaderPathLink(reference2) {
  ...
  for (
    ...
    const selectedFilePath =
      ...
      reference2.attachments[attachmentindex].title +
      "](" +
      encodeURI(reference2.attachments[attachmentindex].select).replace(
        "select",
        "open-pdf"
      ) +
      ")";
    ...
    return __async(this, null, function* () {
      ...
      for (
        ...
        const indexSelectedReference = this.data.items.findIndex(
          (item) =>
            item.citationKey === citeKeyToBeProcessed[indexNoteToBeProcessed]
        );
...
var updateLibrary = class extends import_obsidian2.Modal {
  ...
  onOpen() {
    ...
    for (let index = 0; index < data.items.length; index++) {
      ...
      if (
        this.plugin.settings.updateLibrary === "Only update existing notes" &&
        !fs.existsSync(
          createNoteTitle(
            selectedEntry,
            this.plugin.settings.exportTitle,
...
var FolderSuggest = class extends TextInputSuggest {
  getSuggestions(inputStr) {
    ...
    abstractFiles.forEach((folder) => {
      if (
        folder instanceof import_obsidian4.TFolder &&
...
var SettingTab = class extends import_obsidian5.PluginSettingTab {
  ...
  display() {
    ...
    new import_obsidian5.Setting(settingsExport)
      .setName("Export Path")
      .setDesc(
    ...
    new import_obsidian5.Setting(settingsExport)
      ...
      .setDesc("Select one of the default templates or provide a custom one.")
      .addDropdown((d) => {
    ...
    if (settings.templateType === "Custom") {
      new import_obsidian5.Setting(settingsExport)
        ...
        .addTextArea((text) => {
          ...
          text.setValue(settings.templateContent).onChange((value) =>
            __async(this, null, function* () {
    ...
    if (settings.missingfield === "Replace with custom text") {
      new import_obsidian5.Setting(settingsExport)
        ...
        .addText((text) =>
          text.setValue(settings.missingfieldreplacement).onChange((value) =>
            __async(this, null, function* () {
    ...
    new import_obsidian5.Setting(settingsExport)
      ...
      .addTextArea((text) =>
        text.setValue(settings.multipleFieldsDivider).onChange((value) =>
          __async(this, null, function* () {
    ...
    new import_obsidian5.Setting(settingsExport)
      ...
      .addTextArea((text) =>
        text.setValue(settings.nameFormat).onChange((value) =>
          __async(this, null, function* () {
    ...
    if (settings.saveManualEdits == "Select Section") {
      new import_obsidian5.Setting(settingsExport)
        ...
        .addText((text) =>
          text.setValue(settings.saveManualEditsStart).onChange((value) =>
            __async(this, null, function* () {
      ...
      if (settings.saveManualEdits) {
        new import_obsidian5.Setting(settingsExport)
          ...
          .addText((text) =>
            text.setValue(settings.saveManualEditsEnd).onChange((value) =>
              __async(this, null, function* () {
    ...
    new import_obsidian5.Setting(settingsCitations)
    ...
    new import_obsidian5.Setting(settingsCitations)
      ...
      .addToggle((text) =>
        text.setValue(settings.highlightCitationsLink).onChange((value) =>
          __async(this, null, function* () {
    ...
    new import_obsidian5.Setting(settingsCitations)
      ...
      .addTextArea((text) =>
        text.setValue(settings.highlightExportTemplate).onChange((value) =>
          __async(this, null, function* () {
    ...
    new import_obsidian5.Setting(settingsHighlights)
      .setName("Double Spaced")
      .setDesc(
        "Set toggle to on to add an empty space between different highlights"
      )
      .addToggle((text) =>
        text.setValue(settings.isDoubleSpaced).onChange((value) =>
          __async(this, null, function* () {
    ...
    new import_obsidian5.Setting(settingsHighlights)
      ...
      .addToggle((text) =>
        text.setValue(settings.isHighlightQuote).onChange((value) =>
          __async(this, null, function* () {
    ...
    new import_obsidian5.Setting(settingsHighlights)
      .setName("Bold")
      .addToggle((text) =>
        text.setValue(settings.isHighlightBold).onChange((value) =>
          __async(this, null, function* () {
    ...
    new import_obsidian5.Setting(settingsHighlights)
      .setName("Italic")
      .addToggle((text) =>
        text.setValue(settings.isHighlightItalic).onChange((value) =>
          __async(this, null, function* () {
    ...
    new import_obsidian5.Setting(settingsHighlights)
      ...
      .addToggle((text) =>
        text.setValue(settings.isHighlightHighlighted).onChange((value) =>
          __async(this, null, function* () {
    ...
    new import_obsidian5.Setting(settingsHighlights)
      ...
      .addToggle((text) =>
        text.setValue(settings.isHighlightColoured).onChange((value) =>
          __async(this, null, function* () {
    ...
    new import_obsidian5.Setting(settingsHighlights)
      ...
      .addToggle((text) =>
        text.setValue(settings.isHighlightBullet).onChange((value) =>
          __async(this, null, function* () {
    ...
    new import_obsidian5.Setting(settingsHighlights)
      .setName("Blockquote")
      .addToggle((text) =>
        text.setValue(settings.isHighlightBlockquote).onChange((value) =>
          __async(this, null, function* () {
    ...
    new import_obsidian5.Setting(settingsHighlights)
      ...
      .addTextArea((text) =>
        text.setValue(settings.highlightCustomTextBefore).onChange((value) =>
          __async(this, null, function* () {
    ...
    new import_obsidian5.Setting(settingsHighlights)
      ...
      .addTextArea((text) =>
        text.setValue(settings.highlightCustomTextAfter).onChange((value) =>
          __async(this, null, function* () {
    ...
    new import_obsidian5.Setting(settingsComments)
      .setName("Quotation Marks")
      .addToggle((text) =>
        text.setValue(settings.isCommentQuote).onChange((value) =>
          __async(this, null, function* () {
    ...
    new import_obsidian5.Setting(settingsComments)
      .setName("Bold")
      .addToggle((text) =>
        text.setValue(settings.isCommentBold).onChange((value) =>
          __async(this, null, function* () {
    ...
    new import_obsidian5.Setting(settingsComments)
      .setName("Italic")
      .addToggle((text) =>
        text.setValue(settings.isCommentItalic).onChange((value) =>
          __async(this, null, function* () {
    ...
    new import_obsidian5.Setting(settingsComments)
      .setName("Highlighted (markdown)")
      .addToggle((text) =>
        text.setValue(settings.isCommentHighlighted).onChange((value) =>
          __async(this, null, function* () {
    ...
    new import_obsidian5.Setting(settingsComments)
      .setName("Highlighted (original colour)")
      .addToggle((text) =>
        text.setValue(settings.isCommentColoured).onChange((value) =>
          __async(this, null, function* () {
    ...
    new import_obsidian5.Setting(settingsComments)
      .setName("Bullet Points")
      .addToggle((text) =>
        text.setValue(settings.isCommentBullet).onChange((value) =>
          __async(this, null, function* () {
    ...
    new import_obsidian5.Setting(settingsComments)
      .setName("Blockquote")
      .addToggle((text) =>
        text.setValue(settings.isCommentBlockquote).onChange((value) =>
          __async(this, null, function* () {
    ...
    new import_obsidian5.Setting(settingsComments)
      ...
      .addTextArea((text) =>
        text.setValue(settings.commentCustomTextBefore).onChange((value) =>
          __async(this, null, function* () {
    ...
    new import_obsidian5.Setting(settingsComments)
      ...
      .addTextArea((text) =>
        text.setValue(settings.commentCustomTextAfter).onChange((value) =>
          __async(this, null, function* () {
    ...
    new import_obsidian5.Setting(settingsTags).setDesc(
      "In order to extract tags added from the Zotero PDF reader, open Zotero -> Preferences -> Advanced -> Config Editor -> extensions.zotero.annotations.noteTemplates.highlight <br> Replace default value with: <p>{{highlight quotes='true'}} {{citation}} {{comment}} {{if tags}} Tag: {{tags join='; '}}{{endif}}</p>"
    );
    new import_obsidian5.Setting(settingsTags)
      .setName("Hash sign (#)")
      .addToggle((text) =>
        text.setValue(settings.isTagHash).onChange((value) =>
          __async(this, null, function* () {
    ...
    new import_obsidian5.Setting(settingsTags)
      .setName("Quotation Marks")
      .addToggle((text) =>
        text.setValue(settings.isTagQuote).onChange((value) =>
          __async(this, null, function* () {
    ...
    new import_obsidian5.Setting(settingsTags)
      .setName("Bold")
      .addToggle((text) =>
        text.setValue(settings.isTagBold).onChange((value) =>
          __async(this, null, function* () {
    ...
    new import_obsidian5.Setting(settingsTags)
      .setName("Italic")
      .addToggle((text) =>
        text.setValue(settings.isTagItalic).onChange((value) =>
          __async(this, null, function* () {
    ...
    new import_obsidian5.Setting(settingsTags)
      .setName("Highlighted (markdown)")
      .addToggle((text) =>
        text.setValue(settings.isTagHighlighted).onChange((value) =>
          __async(this, null, function* () {
    ...
    new import_obsidian5.Setting(settingsTags)
      .setName("Highlighted (original colour)")
      .addToggle((text) =>
        text.setValue(settings.isTagColoured).onChange((value) =>
          __async(this, null, function* () {
    ...
    new import_obsidian5.Setting(settingsTags)
      .setName("Bullet Points")
      .addToggle((text) =>
        text.setValue(settings.isTagBullet).onChange((value) =>
          __async(this, null, function* () {
    ...
    new import_obsidian5.Setting(settingsTags)
      .setName("Blockquote")
      .addToggle((text) =>
        text.setValue(settings.isTagBlockquote).onChange((value) =>
          __async(this, null, function* () {
    ...
    new import_obsidian5.Setting(settingsTags)
      ...
      .addTextArea((text) =>
        text.setValue(settings.tagCustomTextBefore).onChange((value) =>
          __async(this, null, function* () {
    ...
    new import_obsidian5.Setting(settingsTags)
      ...
      .addTextArea((text) =>
        text.setValue(settings.tagCustomTextAfter).onChange((value) =>
          __async(this, null, function* () {
    ...
    new import_obsidian5.Setting(settingsAdvanced).setDesc(
    ...
    new import_obsidian5.Setting(settingsAdvanced)
      .setName("Heading Level 1")
      .addText((text) =>
        text.setValue(settings.keyH1).onChange((value) =>
          __async(this, null, function* () {
    ...
    new import_obsidian5.Setting(settingsAdvanced)
      ...
      .addText((text) =>
        text.setValue(settings.keyH2).onChange((value) =>
          __async(this, null, function* () {
    ...
    new import_obsidian5.Setting(settingsAdvanced)
      ...
      .addText((text) =>
        text.setValue(settings.keyH4).onChange((value) =>
          __async(this, null, function* () {
    ...
    new import_obsidian5.Setting(settingsAdvanced)
      ...
      .addText((text) =>
        text.setValue(settings.keyH5).onChange((value) =>
          __async(this, null, function* () {
    ...
    new import_obsidian5.Setting(settingsAdvanced)
      ...
      .addText((text) =>
        text.setValue(settings.keyH6).onChange((value) =>
          __async(this, null, function* () {
    ...
    new import_obsidian5.Setting(settingsAdvanced)
      ...
      .addText((text) =>
        text.setValue(settings.keyMergeAbove).onChange((value) =>
          __async(this, null, function* () {
    ...
    new import_obsidian5.Setting(settingsAdvanced)
      ...
      .addText((text) =>
        text.setValue(settings.keyCommentPrepend).onChange((value) =>
          __async(this, null, function* () {
    ...
    new import_obsidian5.Setting(settingsAdvanced)
      .setDesc(
        "Always place the comment made to an highlight before the text of the highlight"
      )
      .addToggle((text) =>
        text.setValue(settings.commentPrependDefault).onChange((value) =>
          __async(this, null, function* () {
    ...
    new import_obsidian5.Setting(settingsAdvanced)
      ...
      .addText((text) =>
        text.setValue(settings.keyTask).onChange((value) =>
          __async(this, null, function* () {
            if (Object.values(settings).indexOf(value) > -1) {
              alert(
                "This value is already assigned to a different transformation. Chose a different value"
    ...
    new import_obsidian5.Setting(settingsColour).setDesc(
    ...
    new import_obsidian5.Setting(settingsColour)
      .setName("Yellow")
      .setDesc("")
      .addText((text) =>
        text.setValue(settings.colourYellowText).onChange((value) =>
          __async(this, null, function* () {
    ...
    new import_obsidian5.Setting(settingsColour)
      ...
      .setDesc("")
      .addText((text) =>
        text.setValue(settings.colourRedText).onChange((value) =>
          __async(this, null, function* () {
    ...
    new import_obsidian5.Setting(settingsColour)
      ...
      .setDesc("")
      .addText((text) =>
        text.setValue(settings.colourGreenText).onChange((value) =>
          __async(this, null, function* () {
    ...
    new import_obsidian5.Setting(settingsColour)
      ...
      .setDesc("")
      .addText((text) =>
        text.setValue(settings.colourBlueText).onChange((value) =>
          __async(this, null, function* () {
    ...
    new import_obsidian5.Setting(settingsColour)
      ...
      .setDesc("")
      .addText((text) =>
        text.setValue(settings.colourPurpleText).onChange((value) =>
          __async(this, null, function* () {
    ...
    new import_obsidian5.Setting(settingsColour)
      ...
      .setDesc("")
      .addText((text) =>
        text.setValue(settings.colourBlackText).onChange((value) =>
          __async(this, null, function* () {
    ...
    new import_obsidian5.Setting(settingsColour)
      ...
      .setDesc("")
      .addText((text) =>
        text.setValue(settings.colourWhiteText).onChange((value) =>
          __async(this, null, function* () {
    ...
    new import_obsidian5.Setting(settingsColour)
      ...
      .setDesc("")
      .addText((text) =>
        text.setValue(settings.colourGrayText).onChange((value) =>
          __async(this, null, function* () {
    ...
    new import_obsidian5.Setting(settingsColour)
      ...
      .setDesc("")
      .addText((text) =>
        text.setValue(settings.colourOrangeText).onChange((value) =>
          __async(this, null, function* () {
    ...
    new import_obsidian5.Setting(settingsColour)
      ...
      .setDesc("")
      .addText((text) =>
        text.setValue(settings.colourCyanText).onChange((value) =>
          __async(this, null, function* () {
    ...
    new import_obsidian5.Setting(settingsColour)
      ...
      .setDesc("")
      .addText((text) =>
        text.setValue(settings.colourMagentaText).onChange((value) =>
          __async(this, null, function* () {
    ...
    new import_obsidian5.Setting(settingsColour)
      ...
      .setDesc("")
      .addText((text) =>
        text.setValue(settings.colourCustomHexValue).onChange((value) =>
          __async(this, null, function* () {
    ...
    new import_obsidian5.Setting(settingsColour)
      ...
      .setDesc("")
      .addText((text) =>
        text.setValue(settings.colourCustomHexText).onChange((value) =>
          __async(this, null, function* () {
    ...
    new import_obsidian5.Setting(importImages)
      ...
      .addToggle((text) =>
        text.setValue(settings.imagesImport).onChange((value) =>
          __async(this, null, function* () {
    ...
    new import_obsidian5.Setting(importImages)
      ...
      .addText((text) =>
        text.setValue(settings.zoteroStoragePathManual).onChange((value) =>
          __async(this, null, function* () {
    ...
    if (settings.imagesImport) {
      new import_obsidian5.Setting(importImages)
        ...
        .addToggle((text) =>
          text.setValue(settings.imagesCopy).onChange((value) =>
            __async(this, null, function* () {
    ...
    new import_obsidian5.Setting(debugSettings)
      .setName("Activate Debug Mode")
      .setDesc(
        "Activating this option will print the console logs of each entry exported in a text file to faciliate debugging."
      )
      .addToggle((text) =>
        text.setValue(settings.debugMode).onChange((value) =>
          __async(this, null, function* () {
...
var MyPlugin = class extends import_obsidian6.Plugin {
  ...
  createFormatting() {
    ...
    const commentHighlighted =
      isCommentHighlighted == true && isCommentColoured == false ? "==" : "";
  ...
  parseMetadata(selectedEntry, templateOriginal) {
    ...
    selectedEntry.itemType =
      selectedEntry.itemType.charAt(0).toUpperCase() +
      selectedEntry.itemType.slice(1);
    selectedEntry.citationInLine =
      createAuthorKey(selectedEntry.creators) + " (" + selectedEntry.year + ")";
    ...
    if (selectedEntry.itemType == "Journal Article") {
      selectedEntry.citationShort =
        selectedEntry.citationInLine + " '" + selectedEntry.title + "'";
    ...
    for (let indexLines = 0; indexLines < lines.length; indexLines++) {
      ...
      lineElements.commentText =
        lineElements.annotationType === "noKey"
          ? lineElements.commentText
          : lineElements.commentText
              .substring(firstBlank, lineElements.commentText.length)
              .trim();
    ...
    for (let indexLines = 1; indexLines < lengthLines; indexLines++) {
      ...
      if (/"annotationKey":"[a-zA-Z0-9]+/gm.test(selectedLineOriginal)) {
        let annotationKey = String(
          selectedLineOriginal.match(/"annotationKey":"[a-zA-Z0-9]+/gm)
        );
      ...
      if (endCiteKey > 0) {
        ...
        lineElements.commentText =
          ...
          lineElements.annotationType === "typeImage"
            ? annotationCommentAll
            : annotationCommentAll
                .substring(firstBlank, annotationCommentAll.length)
                .trim();
        if (
          lineElements.commentText.includes(this.settings.TagBeginningConfig)
        ) {
          if (this.settings.TagEndConfig.length == 0) {
            lineElements.inlineTagsText = lineElements.commentText.slice(
              lineElements.commentText.indexOf(
                this.settings.TagBeginningConfig
              ),
        ...
        if (typeof lineElements.inlineTagsText !== `undefined`) {
          lineElements.inlineTagsText = lineElements.inlineTagsText.replace(
            this.settings.TagBeginningConfig,
            ""
          );
          if (this.settings.TagEndConfig.length != 0) {
          ...
          lineElements.inlineTagsArray = lineElements.inlineTagsText.split(
            this.settings.TagDividerConfig
          );
          if (lineElements.annotationType !== "typeImage") {
            for (
              let indexTag = 0;
              indexTag < lineElements.inlineTagsArray.length;
              indexTag++
            ) {
  ...
  formatColourHighlight(lineElements) {
    ...
    if (lineElements.highlightColour.includes("#ffd400")) {
      ...
      lineElements.highlightColour.includes(this.settings.colourCustomHexValue)
    ) {
      ...
      if (HexRegex.test(lineElements.highlightColour)) {
        const colorClassifier = new import_color_classifier.default(
          import_color_classifier.Palette.RAINBOW,
          import_color_classifier.AlgorithmTypes.HSV
        );
        lineElements.highlightColour = colorClassifier.classify(
          String(lineElements.highlightColour.match(HexRegex)),
          "hex"
        );
      }
      if (
        ["##000000", "#000000"].some((colorStr) =>
  ...
  formatNoteElements(noteElements, citeKey) {
    ...
    for (let i = 0; i < noteElements.length; i++) {
      ...
      if (
        ...
        if (
          this.settings.highlightCitationsFormat === "Only page number" &&
          lineElements.pageLabel !== void 0
        ) {
      ...
      const highlightFormatBeforeColoured = highlightFormatBefore.replace(
        "SELECTED_COLOUR",
        lineElements.highlightColour + ";"
      );
      const commentFormatBeforeColoured = highlightFormatBefore.replace(
        "SELECTED_COLOUR",
        lineElements.highlightColour + ";"
      );
      const tagFormatBeforeColoured = highlightFormatBefore.replace(
        "SELECTED_COLOUR",
        lineElements.highlightColour + ";"
      );
      ...
      if (this.settings.isTagHash == true) {
        for (
          ...
          lineElements.inlineTagsArray[index] = lineElements.inlineTagsArray[
            index
          ].replace(/ /g, "");
        }
      }
      ...
      if (lineElements.annotationType === "typeImage") {
        ...
        if (this.settings.imagesImport) {
          ...
          if (this.settings.zoteroStoragePathManual.length > 0) {
            pathImageOld = import_path2.default.format({
              dir:
                this.settings.zoteroStoragePathManual + lineElements.imagePath,
              base: "image.png",
            });
          }
          pathImageNew = import_path2.default.normalize(
            import_path2.default.format({
              dir: (0, import_obsidian6.normalizePath)(
                this.app.vault.adapter.getBasePath() +
                  "\\" +
      ...
      if (/typeH\d/.test(lineElements.annotationType)) {
        const lastChar =
          lineElements.annotationType[lineElements.annotationType.length - 1];
  ...
  extractAnnotation(selectedEntry, noteTitleFull) {
    ...
    if (selectedEntry.attachments[0] !== void 0) {
      ...
      if (zoteroStorageWindows.test(selectedEntry.attachments[0].path)) {
        pathZoteroStorage = String(
          selectedEntry.attachments[0].path.match(zoteroStorageWindows)
        );
  ...
  compareOldNewNote(existingNote, newNote, authorKey) {
    ...
    if (this.settings.saveManualEdits == "Select Section") {
      ...
      const newNoteCombined =
        newNotePreservedBefore + existingNotePreserved + newNotePreservedAfter;
